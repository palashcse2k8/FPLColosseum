...
public class LatestInjuredPlayerListAdapter extends RecyclerView.Adapter<LatestInjuredPlayerListAdapter.PlayerViewHolder> {
    ...
    public LatestInjuredPlayerListAdapter(List<PlayersData> playersList, String sortingCriterion, FragmentActivity activity) {
    ...
    public PlayerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_latest_injury_item, parent, false);
    ...
    class PlayerViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView plaerStatus;
        ...
        public PlayerViewHolder(@NonNull View itemView) {
            ...
            plaerStatus = itemView.findViewById(R.id.player_status);
...
//                            Log.e("Image Load Error", "Failed to load image: " + e.getMessage());
            ...
            updateCriterionText(plaerStatus, player, sortingCriterion);
        }
        ...
        private void updateCriterionText(TextView tv, PlayersData playersData, String sortingCriterion) {
            ...
            switch (selectedCriterion) {
                ...
                case EXPECTED_GOALS_CONCEDED:
                    ...
                    break;
                case NEWS_ADDED:
                    tv.setText(playersData.getNews()); // Example field
                    break;
                default:
